...
def convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(ltspice_txt_file, bode_100_file, fmin_Hz=100.0, fmax_Hz=10E6):
    ...
    line2 = ax1.semilogx(meas_freq, meas_gain, color='red', label='Measured Magnitude')
    ax1.tick_params(axis='y')
    ax1.set_xlim([fmin_Hz, fmax_Hz])
    ax1.set_ylim([-90.,90.])
    ax1.set_yticks(np.arange(-90.0,90.001,10.0)) # Increments of 10.0
    ##ax1.grid(True, which='both')
    ax1.grid(True, which='major', color='0.25') # Solid lines, Black
    ax1.grid(True, which='minor', linestyle='--', color='0.7') # Dashed lines, light gray color
    ...
    line3 = ax2.semilogx(sim_data[0], sim_data[2],  color='magenta', linestyle='-', label='Simulated Phase')
    line4 = ax2.semilogx(meas_freq, meas_phase,  color='blue', label='Measured Phase')
    ax2.set_xlim([fmin_Hz, fmax_Hz])
    # Set y-axis increments
##    ax2.set_yticks(np.arange(-180.0,180.001,45.0)) # Increments of 45
    ax2.set_yticks(np.arange(-180.0,180.001,20.0)) # Increments of 20.0
    ax2.set_ylim([-180.,180.])
    ...
    # 1. Make it big (dimensions in inches: width=12, height=8)
    fig.set_size_inches(20, 15)
    # 2. Save it correctly (bbox_inches='tight' prevents labels from getting cut off)
    
    saved_png_filename = ltspice_txt_file.replace('.txt','.png')
    saved_png_filename = saved_png_filename.replace('Sim','Sim_vs_Measured')
    plt.savefig(saved_png_filename, bbox_inches='tight', dpi=600)
##    plt.show()
...
if __name__ == "__main__":
    ...
    sim_ltspice_data1 = 'Sim_Loop_Response_30Vin_Min_100Ohm_Load.txt'
    meas_bode_data1 = 'Loop_Response_30Vin_Min_100Ohm_Load_2026-06-09T11_20_02.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_bode_data1, fmin_Hz=100.0, fmax_Hz=10.0E6)


    sim_ltspice_data2 = 'Sim_Plant_Response_30Vin_Min_100Ohm_Load.txt'
    meas_bode_data2 = 'Plant_Response_30Vin_Min_100Ohm_Load_2026-06-05T20_43_56.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data2,
                                                                  meas_bode_data2, fmin_Hz=1.0, fmax_Hz=10.0E6)


    sim_ltspice_data3 = 'Sim_Compensator_Response_30Vin_Min_100Ohm_Load.txt'
    meas_bode_data3 = 'Compensator_Response_30Vin_Min_100Ohm_Load_2026-06-05T20_43_56.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data3,
                                                                  meas_bode_data3, fmin_Hz=1.0, fmax_Hz=10.0E6)

    sim_ltspice_data4 = 'Sim_Opto_Response_30Vin_Min_100Ohm_Load.txt'
    meas_bode_data4 = 'Opto_Response_30Vin_Min_100Ohm_Load_2026-06-05T20_43_56.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data4,
                                                                  meas_bode_data4, fmin_Hz=100.0, fmax_Hz=10.0E6)

    sim_ltspice_data1 = 'Sim_Loop_Response_30Vin_Max_2Ohm_Load.txt'
    meas_bode_data1 = 'Loop_Response_30Vin_Max_2Ohm_Load_2026-06-11T16_46_03.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_bode_data1, fmin_Hz=10.0, fmax_Hz=10.0E6)


    sim_ltspice_data2 = 'Sim_Plant_Response_30Vin_Max_2Ohm_Load.txt'
    meas_bode_data2 = 'Plant_Response_30Vin_Max_2Ohm_Load_2026-06-05T20_43_56.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data2,
                                                                  meas_bode_data2, fmin_Hz=1.0, fmax_Hz=10.0E6)


    sim_ltspice_data3 = 'Sim_Compensator_Response_30Vin_Max_2Ohm_Load.txt'
    meas_bode_data3 = 'Compensator_Response_30Vin_Max_2Ohm_Load_2026-06-11T18_17_26.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data3,
                                                                  meas_bode_data3, fmin_Hz=1.0, fmax_Hz=10.0E6)

    sim_ltspice_data4 = 'Sim_Opto_Response_30Vin_Max_2Ohm_Load.txt'
    meas_bode_data4 = 'Opto_Response_30Vin_Max_2Ohm_Load_2026-06-11T17_52_19.csv'
    convert_LTSPICE_txt_and_Bode_100_Gain_files_to_csv_and_plot(sim_ltspice_data4,
                                                                  meas_bode_data4, fmin_Hz=1.0, fmax_Hz=10.0E6)
