...
def convert_venable_dat_file_to_csv(venable_dat_file):
...
def convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(ltspice_txt_file, venable_dat_file, venable_mag_scaling_factor_dB = 0):
...
if __name__ == "__main__":
    ...
    sim_ltspice_data1 = 'Impedance_AB_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_A_and_B_Untrimmed_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)
    sim_ltspice_data1 = 'Impedance_21_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_1_and_2_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_43_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_3_and_4_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)
    sim_ltspice_data1 = 'Impedance_56_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_5_and_6_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_78_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_7_and_8_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)
    sim_ltspice_data1 = 'Impedance_9_10_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Pins_9_and_10_Everything_Else_Open.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)
      

    sim_ltspice_data1 = 'Impedance_AB_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_A_and_B_Untrimmed_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_21_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_1_and_2_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_43_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_3_and_4_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_56_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_5_and_6_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_78_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_7_and_8_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)

    sim_ltspice_data1 = 'Impedance_9_10_Everything_Shorted_Sim.txt'
    meas_venable_data1 = 'Pins_9_and_10_Everything_Else_Shorted.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = -20)


    sim_ltspice_data1 = 'Transmission_AB_to_21_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Transmission_Response_CH1_AB_CH2_Pins_1_and_2.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = 0)
    sim_ltspice_data1 = 'Transmission_AB_to_43_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Transmission_Response_CH1_AB_CH2_Pins_3_and_4.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = 0)
    sim_ltspice_data1 = 'Transmission_AB_to_56_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Transmission_Response_CH1_AB_CH2_Pins_5_and_6.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = 0)
    sim_ltspice_data1 = 'Transmission_AB_to_78_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Transmission_Response_CH1_AB_CH2_Pins_7_and_8.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = 0)
    sim_ltspice_data1 = 'Transmission_AB_to_9_10_Everything_Open_Sim.txt'
    meas_venable_data1 = 'Transmission_Response_CH1_AB_CH2_Pins_9_and_10.dat'
    convert_LTSPICE_txt_and_Venable_FRA_dat_files_to_csv_and_plot(sim_ltspice_data1,
                                                                  meas_venable_data1,
                                                                  venable_mag_scaling_factor_dB = 0)
